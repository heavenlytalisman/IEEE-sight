...
(function() {
  ...
  // Shape definitions: SVG markup and depth factor (0–1)
  const shapes = [
    { svg: '<svg width="200" height="200"><circle cx="100" cy="100" r="80" fill="#ff6f61"/></svg>', depth: 0.8, x: '10%', y: '15%' },
    { svg: '<svg width="300" height="300"><rect x="0" y="0" width="300" height="300" rx="150" fill="#4a90e2"/></svg>', depth: 0.4, x: '70%', y: '30%' }
  ];
